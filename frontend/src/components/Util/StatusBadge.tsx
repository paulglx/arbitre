...
const StatusBadge = (props: any) => {
    ...
    if (status === "not submitted") {
        ...
        return <span
            className="bg-teal-100 text-teal-800 text-xs font-medium px-2.5 py-0.5 rounded border border-teal-500"
        >Success</span>;
        ...
        return <span
            className="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded border border-red-400"
        >Error</span>;
    } else {
        return <span className="text-gray-400">-</span>;
    }
