...
} from "../../features/courses/exerciseApiSlice";
    ...
    return isTutor || isOwner ? (
      <>
        ...
        {actionsDropdown && (
          <div
            id="dropdown"
            className="absolute mt-14 border z-10 bg-white divide-y divide-gray-100 rounded-lg shadow"
          >
            <ul
