  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex items-center justify-center my-8 md:my-12">
        <div className="bg-gray-800 rounded-2xl border border-gray-100 shadow-lg shadow-gray-50 p-8 flex flex-col items-center justify-center">
          <p className="text-gray-100 text-lg m-2 text-center">An open source code judge</p>
          ...
          <p className="text-gray-100 mt-4 text-center hidden md:block">
