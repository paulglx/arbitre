...
class WorkerMain extends _process.ProcessRunner {
  ...
  async _runTest(test, retry, nextTest) {
    ...
    await testInfo._runWithTimeout(async () => {
      ...
      await testInfo._runAsStep({
        ...
        const beforeHooksError = await testInfo._runAndFailOnError(async () => {
          var _currentTestInstrumen;
          await ((_currentTestInstrumen = (0, _globals.currentTestInstrumentation)()) === null || _currentTestInstrumen === void 0 ? void 0 : _currentTestInstrumen.willStartTest(testInfo));
    ...
    await testInfo._runAsStep({
      ...
      await testInfo._runWithTimeout(async () => {
        ...
        const didFinishTestFunctionError = await testInfo._runAndFailOnError(async () => {
          var _currentTestInstrumen2;
          return await ((_currentTestInstrumen2 = (0, _globals.currentTestInstrumentation)()) === null || _currentTestInstrumen2 === void 0 ? void 0 : _currentTestInstrumen2.didFinishTestFunction(testInfo));
        });
    ...
    await testInfo._runAndFailOnError(async () => {
      var _currentTestInstrumen3;
      return await ((_currentTestInstrumen3 = (0, _globals.currentTestInstrumentation)()) === null || _currentTestInstrumen3 === void 0 ? void 0 : _currentTestInstrumen3.didFinishTest(testInfo));
    });
    this._currentTest = null;
