...
class TestInfoImpl {
  ...
  constructor(configInternal, projectInternal, workerParams, test, retry, onStepBegin, onStepEnd) {
  ...
  _addStep(data, parentStep) {
    ...
    if (!parentStep && data.laxParent) {
      const visit = step => {
        ...
        if (!step.endWallTime && step.category === data.category && !step.laxParent) parentStep = step;
