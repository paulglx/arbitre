...
async function mergeEvents(dir, shardReportFiles, reportConfig) {
  const events = [];
  const beginEvents = [];
  const endEvents = [];
  ...
  return [mergeBeginEvents(beginEvents, reportConfig), ...events, mergeEndEvents(endEvents), {
    method: 'onExit',
    params: undefined
  }];
}
function mergeBeginEvents(beginEvents, reportConfig) {
