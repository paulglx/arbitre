  ...
  _setupArtifacts: [async ({
    ...
    const csiListener = {
      ...
      onDidCreateBrowserContext: async context => {
        var _artifactsRecorder;
        await ((_artifactsRecorder = artifactsRecorder) === null || _artifactsRecorder === void 0 ? void 0 : _artifactsRecorder.didCreateBrowserContext(context));
        const testInfo = (0, _globals.currentTestInfo)();
        if (testInfo) attachConnectedHeaderIfNeeded(testInfo, context.browser());
      },
      onDidCreateRequestContext: async context => {
        var _artifactsRecorder2;
        await ((_artifactsRecorder2 = artifactsRecorder) === null || _artifactsRecorder2 === void 0 ? void 0 : _artifactsRecorder2.didCreateRequestContext(context));
      },
      onWillCloseBrowserContext: async context => {
        var _artifactsRecorder3;
        await ((_artifactsRecorder3 = artifactsRecorder) === null || _artifactsRecorder3 === void 0 ? void 0 : _artifactsRecorder3.willCloseBrowserContext(context));
      },
      onWillCloseRequestContext: async context => {
        var _artifactsRecorder4;
        await ((_artifactsRecorder4 = artifactsRecorder) === null || _artifactsRecorder4 === void 0 ? void 0 : _artifactsRecorder4.willCloseRequestContext(context));
      }
    };
    const willStartTest = async testInfo => {
    ...
    const didFinishTestFunction = async testInfo => {
      var _artifactsRecorder5;
      await ((_artifactsRecorder5 = artifactsRecorder) === null || _artifactsRecorder5 === void 0 ? void 0 : _artifactsRecorder5.didFinishTestFunction());
    };
    const didFinishTest = async testInfo => {
      var _artifactsRecorder6;
      await ((_artifactsRecorder6 = artifactsRecorder) === null || _artifactsRecorder6 === void 0 ? void 0 : _artifactsRecorder6.didFinishTest());
    ...
    (0, _globals.setCurrentTestInstrumentation)({
      willStartTest,
    ...
    {
      const firstTestInfo = (0, _globals.currentTestInfo)();
      if (firstTestInfo) await willStartTest(firstTestInfo);
    }
    ...
    {
      const lastTestInfo = (0, _globals.currentTestInfo)();
      if (lastTestInfo) await didFinishTest(lastTestInfo);
    }

    // 4. Cleanup instrumentation.
    (0, _globals.setCurrentTestInstrumentation)(undefined);
